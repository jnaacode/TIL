...
public class PracticeService {
	...
	public void homework() {
		...
		/*
		 * // 3명의 학생 정보를 기록할 수 있게 객체 배열 할당 Student[] arr = new Student[3];
		 * 
		 * // 위의 사용데이터 참고하여 3명의 학생 정보 초기화 // 위의 학생 정보 모두 출력 --> 향상된 for문 이용해서
		 * 
		 * arr[0] = new Student("카리나", 20, 168.2, 70.0, 1, "정보시스템공학과"); arr[1] = new
		 * Student("정해인", 21, 187.3, 80.0, 2, "경영학과"); arr[2] = new Student("박서준", 23,
		 * 179.0, 45.0, 4, "정보통신공학과");
		 * 
		...
		while (flag) {
			...
			Employee employee = new Employee(name, age, heigth, weight, salary, dept);
